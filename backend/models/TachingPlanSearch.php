...
/**
 * TachingPlanSearch represents the model behind the search form about `backend\models\OnlineClass`.
 */
class TachingPlanSearch extends OnlineClass
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['id', 'class_time', 'like_times', 'class_type', 'created_at', 'updated_at', 'teacher_id', 'in_times'], 'integer'],
            [['class_name', 'class_code', 'class_img', 'class_summary', 'class_category', 'class_subject', 'online_time', 'teaching_plan', 'content'], 'safe'],
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'class_name', $this->class_name])
            ...
            ->andFilterWhere(['like', 'class_category', $this->class_category])
            ->andFilterWhere(['like', 'class_subject', $this->class_subject])
