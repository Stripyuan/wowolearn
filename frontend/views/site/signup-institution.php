            ...
            <div class="form-group">
                ...
                <div class="btn-group" style="width: 100%;">
                    <a style="width: 100%;" type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        机构 <span class="caret pull-right" style="margin-top: 9px;"></span>
                    </a>
                    <ul class="dropdown-menu" style="width: 100%;">
                        <li><a href="<?= \yii\helpers\Url::to(['site/signup'])?>">学生</a></li>
                        <li><a href="<?= \yii\helpers\Url::to(['site/signup-teacher'])?>">教师</a></li>
                        <li class="active"><a href="<?= \yii\helpers\Url::to(['site/signup-institution'])?>">机构</a></li>
                    </ul>
                </div>
            </div>
